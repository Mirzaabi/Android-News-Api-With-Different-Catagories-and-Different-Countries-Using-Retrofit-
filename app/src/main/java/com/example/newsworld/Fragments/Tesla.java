...
public class Tesla extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_tesla, container, false);
    ...
    private void fatchNEWS() {
        ...
        Call<Headline> call = Api_Clint.getInstance().getApi().getTeslaHeadline();
