...
import com.example.newsworld.Retrofit.Api_Interface;
...
public class Apple extends Fragment {
    ...
    String mapple_key="everything?q=apple&from=2021-06-29&to=2021-06-29&sortBy=popularity&apiKey=6c0ce265e0bb4053b77258ca2d48aaa3";
    ...
    private void fatchNEWS( ) {
        ...
        Call<Headline> call = Api_Clint.getInstance().getApi().getAppleHeadline();
